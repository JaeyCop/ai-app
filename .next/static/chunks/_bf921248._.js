    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDashboardStats.useMemo": ()=>{
            ...
            const totalWords = history.reduce({
                "useDashboardStats.useMemo.totalWords": (sum, entry)=>sum + (entry.wordCount || 0)
            }["useDashboardStats.useMemo.totalWords"], 0);
            const avgWords = totalGenerations > 0 ? Math.round(totalWords / totalGenerations) : 0;
            const keywordCounts = {};
            history.forEach({
                "useDashboardStats.useMemo": (entry)=>{
            ...
            const sortedKeywords = Object.entries(keywordCounts).sort({
                "useDashboardStats.useMemo.sortedKeywords": (a, b)=>b[1] - a[1]
            }["useDashboardStats.useMemo.sortedKeywords"]);
            ...
            const sortedDays = Object.entries(perDay).sort({
                "useDashboardStats.useMemo.sortedDays": (a, b)=>b[1] - a[1]
            }["useDashboardStats.useMemo.sortedDays"]);
            const mostProductiveDay = sortedDays[0]?.[0] || null;
            const oneWeekAgo = new Date();
            oneWeekAgo.setDate(oneWeekAgo.getDate() - 7);
            const thisWeekGenerated = history.filter({
                "useDashboardStats.useMemo": (entry)=>new Date(entry.date) >= oneWeekAgo
            }["useDashboardStats.useMemo"]).length;
            return {
                totalGenerations,
                lastGeneratedDate,
                totalWords,
...
function DashboardPage() {
    ...
    const { totalGenerations, totalWords, avgWords, lastGeneratedDate, mostUsedKeyword, mostProductiveDay, thisWeekGenerated, uniqueKeywords } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDashboardStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardStats"])(history);
...
_s(DashboardPage, "D1G6psKECmc5y0i2JMGa8pAF84Y=", false, function() {
    return [
...
//# sourceMappingURL=_bf921248._.js.map